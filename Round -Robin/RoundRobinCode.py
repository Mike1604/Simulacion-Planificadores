...
"border :3px solid #2C3333;")
        ...
        self.label_3.setGeometry(QtCore.QRect(180, 430, 311, 81))
...
"border :3px solid #2C3333;")
        ...
        self.spinBox_2.setGeometry(QtCore.QRect(510, 430, 161, 71))
...
"border-radius: 5;")
        ...
        self.tableWidget_2.setGeometry(QtCore.QRect(390, 200, 261, 221))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold SemiConden")
        font.setPointSize(13)
        font.setBold(True)
...
"color: #E7F6F2;")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(440, 430, 161, 61))
...
"")
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(390, 540, 261, 221))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold SemiConden")
        font.setPointSize(13)
        font.setBold(True)
...
"")
        ...
        self.label_18.setGeometry(QtCore.QRect(420, 500, 181, 31))
    ...
    def comenzar(self):
        ...
        while (numProc != len(self.done)):
            ...
            if (len(listos)>0):
                ...
                self.tableWidget_2.setItem(5,0,QTableWidgetItem(str(self.QuantumContador)))
                ...
                for k in range(tp):
                    ...
                    if self.FNuevo:
                        ...
                        numProc = len(self.procesos)
                        self.label_11.setText(str(numProc-act))
                        if(act<numProc) and (len(bloq)+len(listos)+1 < 4):
                            self.procesos[act].status="Listo";
